...
export default {
  ...
  // 确认窗体
  confirm(content: any, elMessageBoxOptions: ElMessageBoxOptions | null) {
  ...
  // 确认删除窗体
  confirmDelete(content: any, elMessageBoxOptions: ElMessageBoxOptions | undefined | null) {
    return ElMessageBox.confirm(content, i18n.global.t('el.messagebox.title'), {
      confirmButtonText: i18n.global.t('el.messagebox.confirm'),
      cancelButtonText: i18n.global.t('el.messagebox.cancel'),
      type: 'warning',
  ...
  // 提交内容
  prompt(content: any, elMessageBoxOptions: ElMessageBoxOptions| undefined | null) {
