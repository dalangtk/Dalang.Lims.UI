  ...
  <div class="my-layout">
    <el-card class="mt8" shadow="never" :body-style="{ paddingBottom: '0' }">
      <el-form :model="state.filterModel" :inline="true" @submit.stop.prevent>
        <el-form-item prop="name">
          <el-input v-model="state.filterModel.proName" placeholder="登录账户" @keyup.enter="onQuery" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card class="my-fill mt8" shadow="never">
      <el-table v-loading="state.loading" :data="state.loginLogListData" row-key="id" style="width: 100%">
        <el-table-column prop="proName" label="登录账号" width="100">
        ...
        <el-table-column prop="proTime" label="登录时间" :formatter="formatterTime" width="160" />
