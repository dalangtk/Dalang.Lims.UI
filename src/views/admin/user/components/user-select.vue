<template>
  <el-dialog v-model="state.showDialog" destroy-on-close :title="title" append-to-body draggable
      ...
      <el-row :gutter="8" style="width: 100%">
        <el-col :xs="24" :sm="9">
          <div class="my-flex-column h100">
            <org-menu @node-click="onOrgNodeClick" :model-value="state.modelValue" :select-first-node="false"
              class="my-flex-fill"></org-menu>
          </div>
        </el-col>
        <el-col :xs="24" :sm="15">
          ...
          <el-card shadow="never" style="margin-top: 8px">
            <el-table ref="userTableRef" :data="state.userListData" style="width: 100%" v-loading="state.loading"
              row-key="id" default-expand-all :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
              :highlight-current-row="!multiple" @row-click="onRowClick" @row-dblclick="onRowDbClick"
