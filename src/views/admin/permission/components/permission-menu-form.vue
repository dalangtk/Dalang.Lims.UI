...
const state = reactive({
  showDialog: false,
  sureLoading: false,
  form: { isValid: true, isKeepAlive: true } as PermissionUpdateMenuInput,
...
const open = async (row: any = {}) => {
  ...
  if (row.id > 0) {
    ...
    state.form = { isValid: true, isKeepAlive: true, icon: 'ele-Memo', parentId: row.parentId } as PermissionUpdateMenuInput
  }
