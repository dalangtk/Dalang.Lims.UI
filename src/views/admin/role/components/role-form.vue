        ...
        <el-row :gutter="35">
          <el-col v-if="form.type === 2" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="上级分组" prop="parentId"
              :rules="[{ required: true, message: '请选择上级分组', trigger: ['change'] }]">
              <el-tree-select v-model="form.parentId" :data="roleTreeData" node-key="id" :props="{ label: 'name' }"
                check-strictly default-expand-all render-after-expand fit-input-width clearable class="w100" />
            </el-form-item>
          </el-col>
