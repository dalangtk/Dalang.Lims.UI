        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="上级接口">
              <el-tree-select v-model="form.parentId" :data="apiTreeData" node-key="id" check-strictly
                default-expand-all render-after-expand fit-input-width clearable class="w100" />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="接口名称" prop="label"
              :rules="[{ required: true, message: '请输入接口名称', trigger: ['blur', 'change'] }]">
              <el-input v-model="form.label" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="接口地址" prop="path"
              :rules="[{ required: true, message: '请输入接口地址', trigger: ['blur', 'change'] }]">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form-item label="接口方法" prop="httpMethods">
              <el-radio-group v-model="form.httpMethods">
                ...
                <el-radio-button value="patch" label="patch" />
