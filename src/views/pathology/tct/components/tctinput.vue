        ...
        <el-col :span="10">
          <div class="form-section">
            ...
            <el-form-item label="标本满意度">
              <el-select v-model="formData.satisfaction" placeholder="请选择">
                <el-option label="满意" value="满意" />
                <el-option label="不满意" value="不满意" />
              </el-select>
            </el-form-item>
            <el-form-item label="鳞状细胞量">
              <el-select v-model="formData.squamousCount" placeholder="请选择">
                <el-option label="<5000" value="<5000" />
                <el-option label=">5000" value=">5000" />
              </el-select>
            </el-form-item>
            <el-form-item label="颈管/化生细胞">
              <el-select v-model="formData.metaplasticCells" placeholder="请选择">
                <el-option label="可见" value="可见" />
                <el-option label="未见" value="未见" />
              </el-select>
            </el-form-item>
            <el-form-item label="红细胞">
              <el-select v-model="formData.rbc" placeholder="请选择">
                <el-option label="未见" value="未见" />
                <el-option label="少量" value="少量" />
              </el-select>
            </el-form-item>
            <el-form-item label="炎细胞覆盖率">
              <el-select v-model="formData.inflammationRate" placeholder="请选择">
            ...
            <el-form-item label="炎症">
              <el-select v-model="formData.inflammation" placeholder="请选择">
            ...
            <el-form-item label="滴虫">
              <el-select v-model="formData.trichomonad" placeholder="请选择">
                <el-option label="未见" value="未见" />
                <el-option label="可见" value="可见" />
              </el-select>
            </el-form-item>
            <el-form-item label="真菌">
              <el-select v-model="formData.fungi" placeholder="请选择">
                <el-option label="未见" value="未见" />
                <el-option label="可见" value="可见" />
              </el-select>
            </el-form-item>
            <el-form-item label="菌群变化">
              <el-select v-model="formData.floraChange" placeholder="请选择">
                <el-option label="未见" value="未见" />
                <el-option label="可见" value="可见" />
              </el-select>
            </el-form-item>
            <el-form-item label="细胞形态学符合放线菌">
              <el-select v-model="formData.actinomyces" placeholder="请选择">
                <el-option label="未见" value="未见" />
              </el-select>
            </el-form-item>
            <el-form-item label="符合单纯疱疹病毒改变">
              <el-select v-model="formData.hsv" placeholder="请选择">
                <el-option label="未见" value="未见" />
              </el-select>
            </el-form-item>
            <el-form-item label="其他">
              <el-select v-model="formData.others" placeholder="请选择">
                <el-option label="未见" value="未见" />
              </el-select>
            </el-form-item>
            <el-form-item label="制片方法">
              <el-select v-model="formData.prepMethod" placeholder="请选择">
        ...
        <el-col :span="14">
          <div class="full-height-container">
            <div class="textarea-item memo-group">
              <label>判读意见/结果</label>
              <el-input v-model="formData.diagnosis" type="textarea" :autosize="false" placeholder="请输入判读意见" />
            </div>
            <div class="textarea-item memo-group">
              <label>结果备注</label>
              <el-input v-model="formData.remarks" type="textarea" :autosize="false" placeholder="请输入结果备注" />
            </div>
            <div class="textarea-item memo-group">
              <label>内注</label>
              <el-input v-model="formData.internalNote" type="textarea" :autosize="false" placeholder="请输入内注" />
            </div>
          </div>
        </el-col>
      </el-row>
