<template>
  <div class="my-layout">
        ...
        <el-col :span="18">
          <el-form :inline="true" @submit.stop.prevent>
            <el-form-item class="search-box-item" label="模板组名称">
              <el-input clearable v-model="state.filter.name" placeholder=""
                @keyup.enter="onQuery">
              </el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-card class="my-fill mt8" shadow="never">
      <el-table v-loading="state.loading" :data="state.codeGroupListData" row-key="id" height="'100%'"
        style="width: 100%; height: 100%" @selection-change="selsChange">
        ...
        <el-table-column v-auths="[perms.update, perms.softDelete, perms.delete]" label="操作" :width="actionColWidth"
          ...
          <template #default="{ row }">
            ...
            <el-button text type="warning" v-if="perms.softDelete" @click="onSoftDelete(row)"
              icon="ele-DeleteFilled">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
import {
  PageInputCodeGroupGetPageInput, CodeGroupGetPageInput, CodeGroupGetPageOutput, CodeGroupGetOutput, CodeGroupAddInput, CodeGroupUpdateInput,
