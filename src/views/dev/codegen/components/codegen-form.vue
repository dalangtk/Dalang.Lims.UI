          ...
          <el-row>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="数据库表名" prop="tableName">
                <el-input v-model="state.config.tableName" required placeholder="模块_子模块 eg:system_role"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="业务名" prop="busName">
                <el-input v-model="state.config.busName" required placeholder="子模块名称 eg:角色管理"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
            ...
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="Api区域名" prop="apiAreaName">
                <el-input v-model="state.config.apiAreaName" placeholder="路由名前缀 eg:system"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="区域分组名" prop="areaGrouping">
                <el-input v-model="state.config.areaGrouping" placeholder="API区域二级分组名称 eg:basedata"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="命名空间" prop="namespace">
                <el-input v-model="state.config.namespace" required placeholder="eg:DaLang.Lims.Web.SystemMamager"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
            ...
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="基类" prop="baseEntity">
                <el-select v-model="state.config.baseEntity" style="width: 100%">
                  <el-option v-for="item in state.entityBaseTypes" :key="item.value" :value="item.value" :label="item.label"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
            ...
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="父菜单" prop="menuPid">
                <el-input v-model="state.config.menuPid" placeholder="eg:系统管理"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
            ...
            <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="View类型" prop="genViewType">
                <el-select v-model="state.config.genViewType" style="width: 100%">
                  <el-option value="Single" label="Single"></el-option>
                  <el-option value="MasterDetail" label="MasterDetail"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <!-- <el-col :xl="8" :lg="8" :md="12" :sm="12" :xs="24">
            ...
            <el-table-column prop="netType" label="类型" width="110">
              <template #default="scope">
                <el-select v-if="!showMode" v-model="scope.row.netType">
                  <el-option v-for="item in state.netTypes" :key="item" :value="item" :label="item"></el-option>
                </el-select>
            ...
            <el-table-column prop="editor" label="组件类型" width="150">
              <template #default="scope">
                <el-select v-if="!showMode" v-model="scope.row.editor">
                  <el-option v-for="item in state.editors" :key="item.value" :value="item.value" :label="item.label"></el-option>
                </el-select>
            ...
            <el-table-column prop="queryType" label="查询方式" width="140">
              <template #default="scope">
                <el-select v-model="scope.row.queryType" v-if="!showMode">
                  <el-option v-for="item in state.operates" :key="item.value" :value="item.value" :label="item.label"></el-option>
                </el-select>
            ...
            <el-table-column prop="includeMode" label="外联方式" width="120">
              <template #default="scope">
                <el-select v-if="!showMode" v-model="scope.row.includeMode" title="对应单选/多选">
                  <el-option v-for="item in state.includes" :key="item.value" :value="item.value" :label="item.label"></el-option>
                </el-select>
