 ...
 * 查询系统参数列表入参
 */
export interface ParameterQueryInput {
 ...
 * 获取单个系统参数返回
 */
export interface ParameterUpdateInput extends ParameterAddInput {
  id: number
}
/**
 * 获取单个系统参数返回
 */
export interface ParameterOutput extends ParameterAddInput {
  id: number
}
 ...
 * 获取系统参数列表返回
 */
export interface ParameterListOutput extends ParameterOutput {
  proId: number
  proName?: string | null
  proTime?: Date | null
  modId: number
...
export interface CodeNameOutput {
  code: string | number | null
  name: string | null
}
export interface LabelValueOutput {
  label: string | null
