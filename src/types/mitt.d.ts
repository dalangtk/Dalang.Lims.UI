...
declare type MittType<T = any> = {
  ...
  refreshBaseGroup: ?T
  refreshBaseItem: ?T
  refreshBaseInstrument: ?T
  refreshBaseEntrustHospital: ?T
  refreshBaseItemReference: ?T
  refreshBaseInstrumentItem: ?T
  refreshBaseInstrumentItemDetail: ?T
  refreshBasePurpose: ?T
  refreshBaseSampleType: ?T
  refreshBaseCustomer: ?T
  refreshBaseExamPlan: ?T
  refreshBaseExamPlanDetail: ?T
  refreshPretreatDataImportConfig: ?T
  refreshPretreatCustomerPurposeMatch: ?T
  refreshParameter: ?T
  refreshBaseEntrustPurpose: ?T
  refreshBaseSequence: ?T
  refreshBaseSortRule: ?T
  refreshBaseSorter: ?T
  refreshBaseAuditRule: ?T
  refreshBaseAskRule: ?T
  refreshBaseAskRuleDetail: ?T
  ...
  refreshPathologySubDisease: ?T
  refreshBasePathologyDisease: ?T
  refreshBasePathologySampleType: ?T
  refreshExamPathologyDigitalSlicing: ?T
}
